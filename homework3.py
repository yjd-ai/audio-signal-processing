...
def DAFunc():
    global digital_signal, Fs
    sg.digit_to_voice(digital_signal, Fs)
...
#==插入播放按钮====================
run_btn = tk.Button(root, text = '播放', bg = "#0078d7", font = 12, fg = 'white', command = DAFunc)
run_btn.place(x=250,y=440,width=120,height=32)
